...
__export(src_exports, {
  ...
  CertifiedTransaction_v26: () => CertifiedTransaction_v26,
  ...
  SWITCH_DELEGATION_FUN_NAME: () => SWITCH_DELEGATION_FUN_NAME,
  ...
  SuiExecuteTransactionResponse_v26: () => SuiExecuteTransactionResponse_v26,
  ...
  SuiTransactionData_v26: () => SuiTransactionData_v26,
  ...
  toSuiTransactionData: () => toSuiTransactionData,
  toTransactionData: () => toTransactionData,
...
var MoveCall = (0, import_superstruct5.object)({
  package: (0, import_superstruct5.union)([(0, import_superstruct5.string)(), SuiObjectRef]),
...
var SuiTransactionData_v26 = (0, import_superstruct5.object)({
  transactions: (0, import_superstruct5.array)(SuiTransactionKind),
  sender: SuiAddress,
...
function toSuiTransactionData(tx_data) {
  return {
...
var CertifiedTransaction_v26 = (0, import_superstruct5.object)({
  transactionDigest: TransactionDigest,
  data: SuiTransactionData_v26,
  txSignature: (0, import_superstruct5.string)(),
  authSignInfo: AuthorityQuorumSignInfo
});
var SuiExecuteTransactionResponse_v26 = (0, import_superstruct5.object)({
  certificate: (0, import_superstruct5.optional)(CertifiedTransaction_v26),
...
var SuiTransactionResponse = (0, import_superstruct5.object)({
  ...
  certificate: (0, import_superstruct5.optional)(
    (0, import_superstruct5.union)([CertifiedTransaction, CertifiedTransaction_v26])
  ),
  effects: TransactionEffects,
...
function toTransactionData(tx_data) {
...
var BCS_0_26_SPEC = {
  structs: __spreadProps(__spreadValues({}, BCS_SPEC.structs), {
    TransactionData: {
      ...
      sender: import_bcs11.BCS.ADDRESS,
      gasPayment: "SuiObjectRef",
      gasPrice: import_bcs11.BCS.U64,
      gasBudget: import_bcs11.BCS.U64
    },
    SenderSignedData: {
      data: "TransactionData",
...
var bcs_0_26 = new import_bcs11.BCS(__spreadProps(__spreadValues({}, (0, import_bcs11.getSuiMoveConfig)()), { types: BCS_0_26_SPEC }));
registerUTF8String(bcs_0_26);
function bcsForVersion(v) {
  if ((v == null ? void 0 : v.major) === 0 && (v == null ? void 0 : v.minor) <= 26) {
    return bcs_0_26;
  }
  return bcs;
}
...
var ValidatorSet = (0, import_superstruct8.object)({
  ...
  pending_delegation_switches: (0, import_superstruct8.object)({ contents: (0, import_superstruct8.array)(ValidatorPair) })
});
...
var LocalTxnDataSerializer = class {
  ...
  constructTransactionDataHelper(tx, originalTx, gasObjectId, signerAddress) {
    return __async(this, null, function* () {
      ...
      if ((version == null ? void 0 : version.major) === 0 && (version == null ? void 0 : version.minor) <= 26) {
        return {
          kind: tx,
  ...
  transformTransactionDataToSignableTransaction(tx) {
    return __async(this, null, function* () {
...
// src/pkg-version.ts
var pkgVersion = "0.0.0-experimental-20230222044138";
...
var JsonRpcProvider = class extends Provider {
  ...
  getRpcApiVersion() {
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (!this.addedHeaders && this.rpcApiVersion && !(0, import_femver2.lt)(versionToString(this.rpcApiVersion), "0.27.0")) {
          this.client = new JsonRpcClient(this.connection.fullnode, {
  ...
  executeTransaction(txnBytes, signature, requestType = "WaitForEffectsCert") {
    return __async(this, null, function* () {
      const version = yield this.getRpcApiVersion();
      if ((version == null ? void 0 : version.major) === 0 && (version == null ? void 0 : version.minor) <= 26) {
        try {
          let resp = yield this.client.requestWithType(
...
var SuiSystemStateUtil = class {
  ...
  static newRequestSwitchlDelegationTxn(delegationId, stakedCoinId, newValidatorAddress, gasBudget, gasPayment, gasPrice) {
    return __async(this, null, function* () {
      return {
        kind: "moveCall",
        data: {
