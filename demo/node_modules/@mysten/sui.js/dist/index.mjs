...
var SuiTransactionData_v26 = object5({
  transactions: array3(SuiTransactionKind),
  sender: SuiAddress,
...
var CertifiedTransaction_v26 = object5({
  transactionDigest: TransactionDigest,
  data: SuiTransactionData_v26,
  txSignature: string5(),
  authSignInfo: AuthorityQuorumSignInfo
});
var SuiExecuteTransactionResponse_v26 = object5({
  certificate: optional4(CertifiedTransaction_v26),
...
var SuiTransactionResponse = object5({
  ...
  certificate: optional4(
    union4([CertifiedTransaction, CertifiedTransaction_v26])
  ),
  effects: TransactionEffects,
...
var bcs_0_26 = new BCS2(__spreadProps(__spreadValues({}, getSuiMoveConfig()), { types: BCS_0_26_SPEC }));
  ...
  getRpcApiVersion() {
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (!this.addedHeaders && this.rpcApiVersion && !lt(versionToString(this.rpcApiVersion), "0.27.0")) {
          this.client = new JsonRpcClient(this.connection.fullnode, {
