...
export declare const SuiTransactionData_v26: import("superstruct").Struct<{
    sender: string;
    gasPayment: {
        digest: string;
        objectId: string;
...
export declare function toSuiTransactionData(tx_data: SuiTransactionData_v26): SuiTransactionData;
export declare const CertifiedTransaction_v26: import("superstruct").Struct<{
    data: {
        sender: string;
        gasPayment: {
            digest: string;
...
export declare const SuiExecuteTransactionResponse_v26: import("superstruct").Struct<{
    effects: {
        effects: {
            status: {
                status: "success" | "failure";
    ...
    confirmed_local_execution: import("superstruct").Struct<boolean, null>;
}>;
export type SuiExecuteTransactionResponse_v26 = Infer<typeof SuiExecuteTransactionResponse_v26>;
...
export declare function getCertifiedTransaction(tx: SuiTransactionResponse | SuiExecuteTransactionResponse): CertifiedTransaction | CertifiedTransaction_v26 | undefined;
export declare function getTransactionDigest(tx: CertifiedTransaction | CertifiedTransaction_v26 | SuiTransactionResponse | SuiExecuteTransactionResponse): TransactionDigest;
export declare function getTransactionSignature(tx: SuiTransactionResponse | CertifiedTransaction | CertifiedTransaction_v26): string[];
