...
export declare function deserializeTransactionBytesToTransactionData(bcs: BCS, bytes: Uint8Array): TransactionData | TransactionData_v26;
export declare function toTransactionData(tx_data: TransactionData_v26 | TransactionData): TransactionData;
/**
 * The TransactionData to be signed and sent to the RPC service.
 *
 * Field `sender` is made optional as it can be added during the signing
